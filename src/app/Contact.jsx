...
const Contact = () => {
  return (
    <>
      <section
        className="bg-stone-100 text-gray-700 py-20 px-12 lg:px-24 lg:py-[120px] overflow-hidden relative z-10"
        id="contact"
      >
          ...
          <div className="flex flex-wrap -mx-4 lg:justify-between">
            <div className="w-full px-4 lg:w-1/2 xl:w-6/12">
              <div className="mb-12 max-w-[570px] lg:mb-0">
                <h2 className="text-3xl font-black text-gray-700 md:text-4xl p-2">
