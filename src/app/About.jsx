  ...
  return (
    <div>
      <section class="py-10 lg:py-20 bg-white">
        <div class="max-w-7xl py-4 mx-auto lg:py-6 md:px-6" id="about">
          <div class="flex flex-wrap ">
            <div class="w-full px-4 mb-10 lg:w-1/2 lg:mb-0 ">
              <div class="lg:max-w-md">
                <div class="px-4 pl-4 mb-6 border-l-4 border-[#006b9f]">
                  <span class="text-sm  uppercase text-gray-900">
                    Who we are?
                  </span>
                ...
                <div class="flex flex-wrap items-center">
                  <div class="w-full px-4 mb-6 sm:w-1/2 md:w-1/2 lg:mb-6">
                    <div class="p-6 bg-[#006b9f] rounded-xl">
                      ...
                      <p class="mt-4 mb-2 text-3xl font-bold text-white">
                        2097
                      </p>
                      <h2 class="text-sm text-white">Projects and Plans</h2>
                    </div>
                  </div>
                  <div class="w-full px-4 mb-6 sm:w-1/2 md:w-1/2 lg:mb-6">
                    <div class="p-6 bg-[#006b9f] rounded-xl">
                      ...
                      <h2 class="text-sm text-white">Helped people</h2>
                    </div>
                  </div>
                  <div class="w-full px-4 mb-6 sm:w-1/2 md:w-1/2 lg:mb-6">
                    <div class="p-6 bg-[#006b9f] rounded-xl">
                      ...
                      <p class="mt-4 mb-2 text-3xl font-bold text-white">74</p>
                      <h2 class="text-sm text-white">Volunteer</h2>
                    </div>
                  </div>
                  <div class="w-full px-4 mb-6 sm:w-1/2 md:w-1/2 lg:mb-6">
                    <div class="p-6 bg-[#006b9f] rounded-xl">
                      ...
                      <p class="mt-4 mb-2 text-3xl font-bold text-white">100</p>
                      <h2 class="text-sm text-white">Timing</h2>
                    </div>
                  </div>
                </div>
              </div>
