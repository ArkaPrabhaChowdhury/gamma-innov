      ...
      <footer className="text-gray-600 body-font bg-white">
        <div className="container px-5 py-8 mx-auto flex items-center sm:flex-row flex-col">
          <a className="flex title-font font-medium items-center md:justify-start justify-center text-gray-900">
            <Image src={logo} alt="Gamma Innovations logo" />
            <span className="ml-3 text-xl">Gamma Innovations</span>
          </a>
          ...
          <span className="inline-flex sm:ml-auto sm:mt-1 mt-4 justify-center sm:justify-start">
            <a
              ...
              href="https://www.facebook.com/profile.php?id=100094675573679"
              target="_blank"
            >
              <svg
                fill="currentColor"
            ...
            >
              <svg className="w-6 h-6 mt-1"
                viewBox="0 0 24 24" version="1.1" fill="#6b7280">
            ...
            <a
              className="ml-3 text-gray-500"
              href="https://www.linkedin.com/company/gamma-innovations"
              target="_blank"
            >
              <svg
                fill="currentColor"
